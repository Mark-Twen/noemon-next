...
const KitCardTwo = ({ dataTwo }) => {
  ...
  return (
    <>
      <h1 className={`${fonts.productCardTitle} text-center pb-[60px] mt-[120px]`}>Perlisten Audio introduces a collection of audio masterpieces that redefine the essence of premium sound within the smart home landscape.</h1>
